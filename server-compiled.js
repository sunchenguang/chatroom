...
if (cluster.isMaster && process.execArgv.indexOf('--debug') < 0 && process.env.NODE_ENV !== 'test' && process.env.NODE_ENV !== 'development' && process.execArgv.indexOf('--singleProcess') < 0) {
    //if (cluster.isMaster) {
